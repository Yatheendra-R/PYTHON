...
for i in range(len(l)):
        for j in range(len(l)):
            if i==0 or i==len(l)-1 or j==len(l)-1 or j==0:  #border elements
                print(l[i][j],end=" ")
            else:
                print('  ',end='')
        print()'''
...
for i in range(r):
    ...
    l.append(l1)
print(l)
for i in range(len(l)):  #main diagonal
    for j in range(len(l)):
        if i==j:
            print(l[i][j])
        else:
...
print(l)
print(len(l))
for i in range(len(l)):   #axial diagonal
            print(l[i][(len(l)-1)-i])'''
#axial diagonal
'''
l=[]                                                               
...
for i in range(r):
    ...
    l.append(l1)
print(l)
for i in range(r):    #axial diagonal
    for j in range(c):
        if i+j==len(l)-1:
            print(l[i][j])
        else:
...
for i in range(r):
    ...
    print( )
print("upper triangle")
s=0   #upper triangle display and sum
for i in range(len(l)):
    for j in range(len(l)):
        if i>=j:
            s+=l[i][j]
...
for i in range(r):
    ...
    print( )
print("lower triangle")
s=0   #lower triangle display and sum
for i in range(len(l)):
    for j in range(len(l)):
        if i<=j:
            s+=l[i][j]
